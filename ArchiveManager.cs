...
namespace ArchiveManager
{
    public partial class ArchiveManager : Form
    {
        ...
        private void ExtractToFolder()
        {
            ...
            if (dlg.ShowDialog() == DialogResult.OK)
            {
                try
                {
                    ...
                    TransferOptions opt = new TransferOptions();
                    opt.Recursive = _settings.Recursive ? RecursionMode.Recursive : RecursionMode.None;
                    opt.FileExistsResolveAction = FileExistsResolveAction.Confirm;
        ...
        private void moveToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (dlg.ShowDialog() == DialogResult.OK)
            {
                try
                {
                    ...
                    TransferOptions opt = new TransferOptions();
                    opt.Recursive = RecursionMode.Recursive;
                    opt.FileExistsResolveAction = FileExistsResolveAction.Confirm;
        ...
        {
            // Synchronize.
            SynchronizeFolders dlg = new SynchronizeFolders(RecursionMode.Recursive, 
